...
namespace Calbee.WMS.Services.Outbound
{
    public static class OutboundServiceProxy
    {
        ...
        private static Calbee.WMS.Services.OutboundService.OutboundService _WS = new Calbee.WMS.Services.OutboundService.OutboundService();
        ...
        public static Calbee.WMS.Services.OutboundService.OutboundService WS
        {
            get
            {
                _WS.Url = "http://" + _IPAddress + "/outboundservice.svc";
