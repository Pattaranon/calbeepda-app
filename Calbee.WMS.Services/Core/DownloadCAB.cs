...
namespace Calbee.WMS.Services.Core
{
    public class DownloadCAB
    {
        ...
        private static Calbee.WMS.Services.CoreService.CoreService _WS = new Calbee.WMS.Services.CoreService.CoreService();
        ...
        public static Calbee.WMS.Services.CoreService.CoreService WS
        {
            get
            {
                _WS.Url = "http://" + _IPAddress + "/Calbee.WMS.Installation.CAB";
