...
namespace Calbee.WMS.Services.Inventory
{
    public static class InventoryServiceProxy
    {
        ...
        private static Calbee.WMS.Services.InventoryService.InventoryService _WS = new Calbee.WMS.Services.InventoryService.InventoryService();
        ...
        public static Calbee.WMS.Services.InventoryService.InventoryService WS
        {
            get
            {
                _WS.Url = "http://" + _IPAddress + "/inventoryservice.svc";
