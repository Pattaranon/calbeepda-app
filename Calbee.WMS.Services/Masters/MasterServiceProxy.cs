...
namespace Calbee.WMS.Services.Masters
{
    public static class MasterServiceProxy
    {
        ...
        private static Calbee.WMS.Services.MasterService.MasterService _WS = new Calbee.WMS.Services.MasterService.MasterService();
        ...
        public static Calbee.WMS.Services.MasterService.MasterService WS
        {
            get
            {
                _WS.Url = "http://" + _IPAddress + "/masterservice.svc";
