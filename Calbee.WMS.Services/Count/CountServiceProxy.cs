...
{
    public static class CountServiceProxy
    {
        ...
        private static Calbee.WMS.Services.CountService.CountService _WS = new Calbee.WMS.Services.CountService.CountService();
        ...
        public static Calbee.WMS.Services.CountService.CountService WS
        {
            get
            {
                _WS.Url = "http://" + _IPAddress + "/countservice.svc";
