...
namespace Calbee.WMS.Services.Authorization
{
    public static class AuthorizeServiceProxy
    {
        ...
        public static Calbee.WMS.Services.AuthorizeService.AuthorizeService WS
        {
            get
            {
                _WS.Url = "http://" + _IPAddress + "/authorizeservice.svc";
